...
function EventCard({ event }: EventCardProp) {
  ...
  return (
    ...
    >
      {/* shadow-[4px_4px_0] shadow-[#EFD9CE]   */}
      <div className='flex flex-row justify-between w-full h-full  border-2 border-gray-800  hover:cursor-pointer group'>
        <div className=' p-4   flex flex-col    rounded-xl   '>
          <div className=''>
            ...
            <div className='text-xl'>{event.artist.name}</div>
          </div>
          ...
          <div className='mt-4  transition-all '>
            <div className='flex flex-col  '>
              <div className='flex space-x-1 items-center  '>
                <div className='text-magint-500  rounded-full hover:bg-opacity-40 '>
                  <span>
                    <svg
