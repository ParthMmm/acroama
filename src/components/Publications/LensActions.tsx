    ...
    <div className='flex gap-6 items-center'>
      ...
      >
        <button aria-label='collect'>
          <div className='flex space-x-1 items-center text-orange-600'>
            <CustomTooltip content={'Collect'} defaultOpen={false}>
              <div className='hover:bg-orange-400 p-1.5 rounded-full hover:bg-opacity-40 transition-all'>
                <span>
                  <svg
      ...
      <button aria-label='collect'>
        <div className='flex space-x-1 items-center text-purple-600'>
          <div className='hover:bg-purple-400 p-1.5 rounded-full hover:bg-opacity-40 transition-all'>
            <span>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
      ...
      <button aria-label='collect'>
        <div className='flex space-x-1 items-center text-blue-600'>
          <div className='hover:bg-blue-400 p-1.5 rounded-full hover:bg-opacity-40 transition-all'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
