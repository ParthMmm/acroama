...
// import { LENS_HUB_ABI, LENS_PERIPHERY_ABI } from './config';
import { ethers } from 'ethers';
import { getSigner, ethersProvider } from './ethers.service';
// import fs from 'fs';
...
//   path.join(__dirname, 'src/abis/lens-periphery-data-provider.json'),
//   'utf8'
// );
